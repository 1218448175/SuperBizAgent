...
本项目的跨项目知识基础设施。与其他项目共享同一个 Obsidian Wiki Vault，知识随项目数量复利增长。
...
1. 先读 `wiki/hot.md`（最近上下文缓存，~500 words）
2. 不够再读 `wiki/index.md`（全库主目录）
3. 需要领域细节时读 `wiki/domains/<领域>/_index.md`
4. 最后才深入具体 Wiki 页面
